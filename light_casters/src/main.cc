...
int main()
{
    ...
    {
        Shader cubeShader("res/shader_source/light_casters/cube.shader");
        Shader lightShader("res/shader_source/light_casters/light.shader");
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            cubeShader.SetFloat("light.outCutOff", glm::cos(glm::radians(25.0f)));
