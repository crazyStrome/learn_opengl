...
int main()
{
    ...
    unsigned char* data = stbi_load("res/pictures/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    data = stbi_load("res/pictures/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    Shader shader("res/shader_source/textures/shader_prac4.shader");
    shader.Use();
